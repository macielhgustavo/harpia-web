...
export const APP_PERMISSIONS = {
  ...
  MONETARY_INDEX_READ: 'MONETARY_INDEX_READ',
  MONETARY_INDEX_CREATE: 'MONETARY_INDEX_CREATE',
  MONETARY_INDEX_UPDATE: 'MONETARY_INDEX_UPDATE',
  MONETARY_INDEX_VALUE_READ: 'MONETARY_INDEX_VALUE_READ',
  MONETARY_INDEX_VALUE_CREATE: 'MONETARY_INDEX_VALUE_CREATE',
  MONETARY_INDEX_VALUE_UPDATE: 'MONETARY_INDEX_VALUE_UPDATE',
  RECEIVABLE_ADJUSTMENT_PREVIEW: 'RECEIVABLE_ADJUSTMENT_PREVIEW',
  RECEIVABLE_ADJUSTMENT_CREATE: 'RECEIVABLE_ADJUSTMENT_CREATE',
  RECEIVABLE_ADJUSTMENT_READ: 'RECEIVABLE_ADJUSTMENT_READ',
} as const;
...
export const PERMISSION_ROUTES = [
  ...
  { route: '/finance/monetary-adjustment', permission: APP_PERMISSIONS.MONETARY_INDEX_READ },
